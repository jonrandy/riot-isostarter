...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.route = __webpack_require__(2);
	var navi = __webpack_require__(4);
	var page = __webpack_require__(5);
	var header = __webpack_require__(6);
	var appRoutes = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('navi', '<a href="{opts.to}" onclick="{navigateToRoute}"> <yield></yield> </a>', '', '', function(opts) {
			var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('page', '<div id="t1"><header></header></div> <div id="t2"><app-router location="{opts.location}"></app-router></div>', '', '', function(opts) {
			setTimeout(function() {
				this.trigger('ready')
			}.bind(this), 500)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app-router', '<router base-route="/"> <route path="/" component="{this.parent.loadHome}"></route> <route path="/browse/:category" component="{this.parent.loadBrowse}"></route> <route path="/product/:category/:productName" component="{this.parent.loadProduct}"></route> </router>', '', '', function(opts) {
			var self = this;
			this.loadHome = function(){
				return new Promise((resolve,reject) => {
					__webpack_require__.e/* nsure */(1, function(require){
						var tagName = __webpack_require__(11);
						resolve("home");
					});
				})
			}
